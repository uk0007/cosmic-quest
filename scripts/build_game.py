...
<body>
  ...
  <div class="app-container">
    ...
    <!-- Modal: Adventure Pause Menu -->
    <div class="modal-overlay" id="modal-adventure-pause" style="display: none; z-index: 9998; justify-content: center; align-items: center;">
    ...
    <!-- Modal: Compact Game Settings -->
    <div class="modal-overlay" id="modal-game-settings" style="display: none; z-index: 9999; justify-content: center; align-items: center;">
    ...
    <div class="modal-overlay" id="modal-confirm-new-game" style="display: none; z-index: 9999; justify-content: center; align-items: center;">
  ...
  <script>
    ...
    function openAdventurePauseMenu() {
      ...
      if (window.CosmicAdventureEngine && window.CosmicAdventureEngine.game) {
        ...
        if (scenes && scenes[0] && scenes[0].physics) {
          scenes[0].physics.world.pause();
        }
      }
